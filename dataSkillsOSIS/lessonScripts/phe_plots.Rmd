...
pheData3 <- pheData2[pheData2$phenophaseName=='Open flowers' & pheData2$phenophaseStatus=='yes',]

tbl <- aggregate(pheData3["dayOfYear"], by=pheData3[c("siteID")], FUN=min)
tbl2 <- aggregate(pheData3["dayOfYear"], by=pheData3[c("siteID")], FUN=max)
tbl3 <- aggregate(pheData3["dayOfYear"], by=pheData3[c("siteID")], FUN=median)

firstLastMed <- rbind(tbl,tbl3,tbl2)

boxplot(dayOfYear~siteID, data =firstLastMed, main="Timing of open flower phenophase per site", 
