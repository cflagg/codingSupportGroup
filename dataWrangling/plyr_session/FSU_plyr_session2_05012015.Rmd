...
# plyr method - becomes a lot more nimble once your data requirements expand
...
# head(
#   ddply(ChickWeight, .(Time,Diet),transform, # notice we use 'transform' here
#       avgWeight = mean(weight), # average weight per chick
#       sdWeight = sd(weight), # standard deviation of weight
#       ), 
#   20)
