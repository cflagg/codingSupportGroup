...
![text](http://image.slidesharecdn.com/datamanipulationusingracm2014-141025211943-conversion-gate01/95/data-manipulation-using-r-dplyr-20-638.jpg?cb=1414290170 "logo text")
...
setwd("C:/Users/cflagg/Documents/GitHub/codingSupportGroup/dataWrangling/plyr_session") 
pathToFiles <- getwd()
...
kable(ddply(pointCheck.output, .(siteID), summarise, 
...
kable(head(pointCheck.output %>% # put it in a pipe!
  filter(pointIDQF == -9999) %>% 
