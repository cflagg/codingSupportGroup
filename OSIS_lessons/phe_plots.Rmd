...
ggplot(aes(x = dayOfYear, y = prop)) + 
  geom_area(aes(group = phenophaseStatus, fill = phenophaseStatus), position = "dodge", alpha=0.75) + scale_fill_manual(values = wes_palette("Darjeeling"))
